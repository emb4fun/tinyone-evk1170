...
{
    extern uint32_t __NonCache_segment_start__[];
    extern uint32_t __NonCache_segment_end__[];
    uint32_t nonCacheStart = (uint32_t)__NonCache_segment_start__;
    uint32_t size          = (uint32_t)__NonCache_segment_end__ - (uint32_t)__NonCache_segment_start__;
